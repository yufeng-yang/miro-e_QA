...
# 2.然后是初始化mediapipe模型
def initialize_face_detector(model_path='/home/yufeng/mdk/bin/trained_model/blaze_face_short_range.tflite'):
    """
    初始化 FaceDetector 实例。
...
def load_emotion_model():
    # class7_names = ['Neutral', 'Happy', 'Sad', 'Surprise', 'Fear', 'Disgust', 'Angry'] # 7种表情的名称
    # 选定设备
    ...
    # 加载模型权重
    # checkpoint = torch.load('/home/yufeng/mdk/bin/affecnet7_epoch19_acc0.671.pth')
    checkpoint = torch.load('/home/yufeng/mdk/bin/affecnet7_epoch19_acc0.671.pth', map_location=torch.device('cpu'))
...
# video_path = '/home/yufeng/mdk/2024-12-09 04-01-41.mkv'
...
# accumulated_feature = None
# # 然后是使用他们
# video_path = '/home/yufeng/mdk/captured_video.mp4'
# frames_dataset = video_to_frames(video_path, frame_interval=2)
# for frame in frames_dataset:
#     face_image = extract_face_area_frame(mediapipe_model, frame)
#     # if face_image:
#     #     face_image.show()
